...
class SwinCD(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=13):
        super(SwinCD, self).__init__()

        self.encoder2 = SwinTransEncoder(img_size, patch_size, in_chans, num_class=2,embed_dim=128,depths=[2,2,18,2],num_heads=[4,8,16,32],window_size=7)
        self.decoder = SwinTransDecoder()


    def forward(self,img1,img2):
        x,x_downsample1,x_downsample2 = self.encoder2(img1,img2)
        x_p,x_2,x_3,x_4 = self.decoder(x,x_downsample1,x_downsample2)
